...
namespace AspNetCore
{
    public class JsonWithFilesFormDataModelBinder : IModelBinder
    {
        ...
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            {
                /*
                 * Because HttpContext.Request.Form.Files is type of IEnumerable<IFormFile>, so that i changed the following code.
                 * if (property.ModelType != typeof(IFormFile))
                 * 
                 */
                if (property.ModelType != typeof(IEnumerable<IFormFile>) && property.ModelType != typeof(IFormFile))
                    continue;
